...
def main():
    ...
    while not loop:
        prev_usr_pos = [Player._loc[0],Player._loc[1]]
        print("1. Go North")
        print("2. Go South")
        print("3. Go East")
        print("4. Go West")
